...
public class AKTable: NSObject, MutableCollection, Codable {
    ...
    // NOTE: upstream's `init(file: AKAudioFile)` is intentionally omitted.
    // Synth One never calls it and AKAudioFile is out of the port scope
    // (docs/02-audiokit-api-surface.md). See Sources/S1Support/PORTING.md.

    /// Offset of the phase
    public var phaseOffset: Int {
        @inline(__always)
        get {
            // PORT FIX: `phase * count` is Float * Int, rejected by modern Swift.

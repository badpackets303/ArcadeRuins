        ...
        do {
            ...
            if let presetJSON = try? JSONSerialization.jsonObject(with: retrievedPresetData, options: []) {
                ...
                if fileName.hasSuffix("json") {
                    ...
                    let importBank = Preset.parseDataToPresets(jsonArray: jsonArray, defaults: conductor.presetDefaults)
                    ...
                    let importedPreset = Preset.parseDataToPreset(presetJSON: presetJSON, defaults: conductor.presetDefaults)

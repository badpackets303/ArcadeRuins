...
class BankEditorViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // PORT FIX (ADR-034): the same fixed near-white field as the preset editor's, with the
        // same white-on-#F8F8F8 text in Dark appearance. Pinned to Light for the same reason.

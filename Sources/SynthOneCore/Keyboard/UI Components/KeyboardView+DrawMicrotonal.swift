...
extension KeyboardView {
    ...
    internal func drawMicrotonal(_ rect: CGRect) {
        ...
        for nn in minNN ... maxNN {
            ...
            // PORT FIX (P4-6): was `UIDevice.current.userInterfaceIdiom`, so under the
            // Mac idiom this picked **10** — the iPhone size — and the microtonal
            // key labels have been drawing too small since ADR-023.
            let fontSize = Conductor.sharedInstance.device == .pad ? 14 : 10
